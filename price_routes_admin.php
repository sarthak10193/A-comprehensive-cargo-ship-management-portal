...
<div id = 'cont' class = 'cont'>
   ...
   <div class = 'left'> 
	<form id = 'left_form' action = 'change_prices.php' method = 'POST'>
    
	<select name = 'weight' class = 'textbox' value='SELECT RANGE	' >
	<option>above 500</option>
	<option>between 120 and 180</option>	
	<option>between 180 and 250</option>
	<option>between 250 and 250	100</option>
	<option>between 350 and 500</option>
	<option>less than 120</option> 
	
	</select>
	<input type = 'text' value ='CHARGES($) '  name = 'price' class = 'textbox'><br>
